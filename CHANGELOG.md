...
- Clarified that live marketplace validation uses the agent-native CLI against
  production account state and platform gift credits, not fake sandbox trades.
